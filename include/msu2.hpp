 ...
 */
template <typename Real> class Msu2 {
public:
  ...
  KOKKOS_INLINE_FUNCTION
  Real abs() const {
    return Kokkos::sqrt(m_a[0] * m_a[0] + m_a[1] * m_a[1] + m_a[2] * m_a[2] +
                        m_a[3] * m_a[3]);
  }
  ...
  KOKKOS_INLINE_FUNCTION
  Msu2 conj() const { return Msu2(m_a[0], -m_a[1], -m_a[2], -m_a[3]); }
  ...
  // Print
  void print() const {
    printf("Msu2: (%.6f, %.6f, %.6f, %.6f)\n", static_cast<double>(m_a[0]),
           static_cast<double>(m_a[1]), static_cast<double>(m_a[2]),
           static_cast<double>(m_a[3]));
  }
};
...
KOKKOS_INLINE_FUNCTION Msu2<Real> mulsu2(const Msu2<Real> &u,
                                         const Msu2<Real> &v) {
  return Msu2<Real>(
 ...
 */
template <typename Real>
KOKKOS_INLINE_FUNCTION Msu2<Real> mulsu2UVDagger(const Msu2<Real> &u,
                                                 const Msu2<Real> &v) {
  return Msu2<Real>(
      u.a0() * v.a0() + u.a1() * v.a1() + u.a2() * v.a2() + u.a3() * v.a3(),
      -u.a0() * v.a1() + u.a1() * v.a0() + u.a2() * v.a3() - u.a3() * v.a2(),
