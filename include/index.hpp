...
void indexNdNm(int id, int x[ND], const LatticeParams& p) {
    int temp = id;
    for (int i = 0; i < ND; ++i) {
        x[i] = temp % p.grid[i];
        temp /= p.grid[i];
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
void indexNdNm(int id, int x[ND], const int X[ND]) {
    int temp = id;
    for (int i = 0; i < ND; ++i) {
        x[i] = temp % X[i];
        temp /= X[i];
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNm(const int x[ND], const LatticeParams& p) {
    int index = 0;
    int factor = 1;
    for (int i = 0; i < ND; ++i) {
        index += x[i] * factor;
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNm(const int x[ND], const int X[ND]) {
    int index = 0;
    int factor = 1;
    for (int i = 0; i < ND; ++i) {
        index += x[i] * factor;
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigNm(int id, int mu, int lmu, const LatticeParams& p) {
    int x[ND];
    indexNdNm<ND>(id, x, p);
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigNm(int id, int mu, int lmu, int nu, int lnu, const LatticeParams& p) {
    int x[ND];
    indexNdNm<ND>(id, x, p);
    x[mu] = (x[mu] + lmu + p.grid[mu]) % p.grid[mu];
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
void indexNdEo(int x[ND], int id, int oddbit, const LatticeParams& p) {
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
void indexNdEo(int x[ND], int id, int oddbit, const int X[ND]) {
    int factor = id / (X[0] / 2);
    for (int i = 1; i < ND; ++i) {
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigEo(int id, int oddbit, int mu, int lmu, const LatticeParams& p) {
    int x[ND];
    ...
    // This matches: int pos = indexNdNm(x) / 2
    int pos = 0;
    int factor = 1;
    for (int i = 0; i < ND; ++i) {
        pos += x[i] * factor;
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigEo(int id, int oddbit, int mu, int lmu, int nu, int lnu, 
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigEo(const int y[ND], int mu, int lmu, const LatticeParams& p) {
    int x[ND];
    for (int i = 0; i < ND; ++i) {
        x[i] = y[i];
    }
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigEo_PlusOne(int id, int oddbit, int mu, const LatticeParams& p) {
    int x[ND];
    indexNdEo<ND>(x, id, oddbit, p);
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdNeigEo_MinusOne(int id, int oddbit, int mu, const LatticeParams& p) {
    int x[ND];
    indexNdEo<ND>(x, id, oddbit, p);
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
void indexNdsNm(int id, int x[ND-1], const LatticeParams& p) {
    int temp = id;
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdsNm(const int x[ND-1], const LatticeParams& p) {
    int index = 0;
    int factor = 1;
    for (int i = 0; i < ND - 1; ++i) {
        index += x[i] * factor;
...
template<int ND = NDIMS>
KOKKOS_INLINE_FUNCTION
int indexNdsNeigNm(int id, int mu, int r, const LatticeParams& p) {
    int x[ND-1];
